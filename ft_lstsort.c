...
/*   Updated: 2020/12/03 19:37:30 by tkomatsu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_mini_ls.h"

static int		cmp_time(t_info *a, t_info *b)
{
...
static t_list	*ft_merge(t_list *a, t_list *b)
{
	t_list	result;
	t_list	*x;
...
static t_list	*ft_mergesort(t_list *lst)
{
	t_list	*a;
	t_list	*b;
	t_list	*x;
